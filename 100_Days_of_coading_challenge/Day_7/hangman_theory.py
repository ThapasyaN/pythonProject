...
# A:TODO-1 - Randomly choose a word from the word_list and assign it to a variable
#  called chosen_word.
...
# E: TODO-3: - Import the logo from hangman_art.py and print it at the start of the game.
...
# E: TODO-4: - If the user has entered a letter they've already guessed, print the
...
# E: TODO-5: - If the letter is not in the chosen_word, print out the letter and let them know
#  it's not in the word.

# B: TODO-3: - Print 'display' and you should see the guessed letter in the correct
...
# D: TODO-3: - print the ASCII art from 'stages' that corresponds to the current number
